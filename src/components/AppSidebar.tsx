...
const ideasItems = [
  ...
  { title: "Ideias Existentes", url: "/ideias", icon: Layers },
...
const agentsItems = [
  { title: "Mapeamento de Mercado", url: "/agentes/mercado", icon: Map },
  { title: "Mapeamento de Dores", url: "/agentes/dores", icon: AlertCircle },
  { title: "Geração de Hipóteses", url: "/agentes/hipoteses", icon: Sparkles },
  { title: "Validação de Hipóteses", url: "/agentes/validacao", icon: ShieldCheck },
  { title: "Geração de POC", url: "/agentes/poc", icon: Beaker },
  { title: "Pesquisa Externa", url: "/agentes/pesquisa", icon: Search },
];

const canvasItems = [
  { title: "Business Canvas", url: "/canvas/business", icon: Grid },
  { title: "Strategy Canvas", url: "/canvas/strategy", icon: BarChart },
];
