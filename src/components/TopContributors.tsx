        ...
        {mockContributors.map((contributor) => (
          ...
          >
            <div className="relative">
              ...
              {contributor.rank <= 3 && (
                <div className={`absolute -top-1 -right-1 h-5 w-5 rounded-full bg-background border-2 flex items-center justify-center ${rankColors[contributor.rank as keyof typeof rankColors]}`}>
