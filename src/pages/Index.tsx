          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-2">
                Bem-vindo ao IdeaFlow
              </h2>
              <p className="text-muted-foreground max-w-3xl">
                Plataforma inteligente para cadastro e validação de ideias de negócio. 
                Aqui você pode submeter suas ideias através de um formulário estruturado e 
                acompanhar o processamento por múltiplos agentes especializados - desde mapeamento 
                de mercado até validação de hipóteses e geração de POC. Cada ideia passa por um 
                processo completo de análise, gerando relatórios detalhados para apoiar suas decisões.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 pt-4">
          <div className="p-6 rounded-lg border bg-card hover:shadow-lg transition-all animate-fade-in">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              análise completa de cada ideia.
            </p>
          </div>

          <div className="p-6 rounded-lg border bg-card hover:shadow-lg transition-all animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <div className="h-10 w-10 rounded-lg bg-accent/10 flex items-center justify-center mb-4">
              <TrendingUp className="h-5 w-5 text-accent" />
            </div>
            <h3 className="font-semibold mb-2">Chain-of-Thought</h3>
            <p className="text-sm text-muted-foreground">
              Raciocínio estruturado em etapas para análise profunda e 
              recomendações fundamentadas.
            </p>
          </div>

          <div className="p-6 rounded-lg border bg-card hover:shadow-lg transition-all animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <div className="h-10 w-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
              <CheckCircle className="h-5 w-5 text-primary" />
            </div>
            <h3 className="font-semibold mb-2">Gestão Colaborativa</h3>
            <p className="text-sm text-muted-foreground">
              Sistema estilo GitHub para sugestões, aprovações e versionamento 
              de ideias em equipe.
            </p>
          </div>
        </section>
